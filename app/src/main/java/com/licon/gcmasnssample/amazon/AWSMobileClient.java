...
import com.licon.gcmasnssample.amazon.config.AWSConfiguration;
...
public class AWSMobileClient {
    ...
    private FCMTokenHelper fcmTokenHelper;
    ...
    private AWSMobileClient(final Context context,
        ...
        this.fcmTokenHelper = new FCMTokenHelper(context, AWSConfiguration
